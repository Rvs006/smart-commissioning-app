# v0.1.44 Docker deployment and rollback
...
For rollback, restore the recorded compatible v0.1.43 digest set with
`up -d --no-build`; restore the database backup at the pre-v0.1.44 head before
