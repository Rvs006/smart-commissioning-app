# v0.1.38 release validation

Date: 2026-08-06
Release status: Candidate with named blockers
Scope: UDMI validation, report generation, portable evidence export
...
| Matching application and independent collector evidence | Open | No paired v0.1.38 run available |
...
- Portable launcher PowerShell parse and v0.1.38 identity contract: passed.
