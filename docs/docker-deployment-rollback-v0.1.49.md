# v0.1.49 Docker deployment and rollback
...
version, worker heartbeat, an approved sealed IP preview, and one report
download.

For rollback, stop the v0.1.49 stack and restore the recorded v0.1.48 digest
