# v0.1.41 Docker deployment and rollback
...
For rollback, restore the recorded compatible v0.1.40 digest set with
`up -d --no-build`; restore the database backup at the pre-v0.1.41 head before
