...
- **Candidate**: v0.1.38 material that still needs field acceptance evidence.
...
| Area | Status | Documents |
| --- | --- | --- |
| Hosted Docker | v0.1.38 candidate | [Docker deployment and rollback](docker-deployment-rollback-v0.1.38.md) |
...
| Database migration | Versioned | [v0.1.26](migration-rollback-v0.1.26.md), [v0.1.27](migration-rollback-v0.1.27.md), [v0.1.28](migration-rollback-v0.1.28.md), [v0.1.29](migration-rollback-v0.1.29.md), [v0.1.30](migration-rollback-v0.1.30.md), [v0.1.31](migration-rollback-v0.1.31.md), [v0.1.36](migration-rollback-v0.1.36.md), [v0.1.37](migration-rollback-v0.1.37.md), [v0.1.38](migration-rollback-v0.1.38.md) |
...
- [Field acceptance checklist](v0.1.38-field-acceptance-checklist.md)
- [Baseline comparison](v0.1.38-baseline-comparison.md)
- [Evidence manifest](v0.1.38-evidence-manifest.md)
- [Reconciliation decision log](v0.1.38-reconciliation-decision-log.md)
