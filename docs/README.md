...
in CI so malformed evidence JSON fails closed with a clear message instead of a
traceback. It is a release-tooling change on top of v0.1.53 with no functional
