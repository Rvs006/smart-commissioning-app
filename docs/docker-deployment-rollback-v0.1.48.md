# v0.1.48 Docker deployment and rollback
...
version, worker heartbeat, an approved sealed IP preview, and one report download.

For rollback, stop the v0.1.48 stack and restore the recorded v0.1.47 digest
