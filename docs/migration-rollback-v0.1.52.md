...
To roll back to v0.1.51, stop v0.1.52 after active work ends and restore the
recorded v0.1.51 EXE or immutable image digests. No Alembic downgrade is
...
v0.1.51 and v0.1.52 API or worker processes.
