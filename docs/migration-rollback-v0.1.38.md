# v0.1.38 migration and rollback

v0.1.38 adds application, report, evidence, and release-provenance fixes
...
Use the exact v0.1.38 workflow artifacts. Deploy the API, worker, and frontend
...
Stop v0.1.38 after active work ends, restore the previously recorded compatible
v0.1.37 package or image digests, and leave the database at
