# v0.1.57 Docker deployment and rollback
...
version, the single-page native scanner screens, worker heartbeat, an approved
sealed IP preview, and one report download.

For rollback, stop the v0.1.57 stack and restore the recorded v0.1.56 digest
