# v0.1.32 - Reports fixes, Windows portable rebuild

This historical Windows rebuild carries the v0.1.32 reports work and the
release-blocker compatibility fix for report-list session creation. The
original v0.1.32 source commit remains the release identity; the compatibility
...
The ZIP was built from the annotated v0.1.32 tag, tested with the core and
