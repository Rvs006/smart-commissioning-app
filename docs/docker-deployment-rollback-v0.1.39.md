# v0.1.39 Docker deployment and rollback
...
2. Set the three recorded digest references, `APP_VERSION=v0.1.39`, and the
...
Restore the previously recorded compatible v0.1.38 digest set and start with
