# v0.1.58 Docker deployment and rollback
...
version, one built-in MQTT discovery capture, worker heartbeat, an approved
sealed IP preview, and one report download.

For rollback, stop the v0.1.58 stack and restore the recorded v0.1.57 digest
