...
| --- | --- | --- |
| Version identity | Packaged source, frontend fallback, matching portable stamp, and mismatch rejection | Automated release gate required |
