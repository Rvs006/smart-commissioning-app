...
class UdmiV1ReportTests(ApiTestCase):
    ...
    def test_technical_report_preserves_run_provenance_and_register_digest(self) -> None:
        ...
        self.assertEqual(provenance["application_version"], "0.1.56")
        ...
        self.assertEqual(portable_provenance["sources"][0]["application_version"], "0.1.56")
